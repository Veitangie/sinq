...
**-V**, **--verbose**
: Enable verbose reporting (reports each stage duration, only affects "std" format).
...
**-n**, **--name** *string*
: Execute only scenarios which names match at least one of passed regular expressions.
